...
exports.fetchDirectories = exports.fetchContent = exports.fetchRootDirectories = exports.writeToFile = exports.downloadS3ContentToLocal = exports.s3 = exports.BUCKET_NAME = void 0;
...
function downloadS3ContentToLocal(object_path, project_name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const s3_objects = yield exports.s3
                .listObjectsV2({
                ...
                for (const content of s3_objects.Contents) {
                    ...
                    if (!content_key.endsWith("/")) {
                        const getObjectParams = {
                            Bucket: exports.BUCKET_NAME !== null && exports.BUCKET_NAME !== void 0 ? exports.BUCKET_NAME : "",
                            Key: content_key,
                        };
                        const data = yield exports.s3.getObject(getObjectParams).promise();
                        console.log("process.env.COPY_DIRECTORY_PATH", process.env.COPY_DIRECTORY_PATH);
                        if (data.Body) {
                            const fileData = data.Body;
                            const filePath = `${process.env.COPY_DIRECTORY_PATH}/${content_key.replace(object_path, "")}`;
...
function fetchRootDirectories(project_name) {
    ...
    const items = fs_1.default.readdirSync(COPY_DIRECTORY_PATH + "", {
        withFileTypes: true,
    });
    items.forEach((item) => {
...
function fetchContent(project_name, filePath) {
    ...
    const content = fs_1.default.readFileSync(process.env.COPY_DIRECTORY_PATH + filePath, "utf-8");
    content.toString();
    return content;
}
